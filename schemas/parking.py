...
class UpdateParkingModel(BaseModel):
    ...
    exit_plate_time: Optional[time] = Field(default=None, description="Hora da leitura de saída")
    exit_status: Optional[str] = Field(default=None, description="Status de leitura de saída, NORMAL, DIVERGENTE")
